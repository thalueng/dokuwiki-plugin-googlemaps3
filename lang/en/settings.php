 ...
 * settings.php	plugin configuration English language strings
 */
$lang['key'] = 'Google Map API key';
$lang['region'] = 'Region Code Biasing';
$lang['language'] = 'Language of Map UI';
$lang['path'] = 'Path to customized icons';
$lang['delim'] = 'Delimiter used for markers';
